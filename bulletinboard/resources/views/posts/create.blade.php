        ...
        <div class="row">
            <div class="col-8 offset-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form
                            @if (Session::get('description')) action="{{ route('post.store') }}"
                            @else
                                action="{{ route('post.confirm') }}" @endif
                            method="POST">
                            @csrf
                                ...
                                @else
                                    ...
                                    <div class="col-9">
                                        <textarea class="form-control" name="description">
                                            @if (Session::get('cancel')) {{ $post['description'] }} @else {{ Request::old('title') }} @endif
                                        </textarea>
                            ...
                            <div class="row mb-3 col-9 offset-2">
                                ...
                                @else
                                    <div class="col-2 me-4 ms-3">
                                        @if (!Session::has('description') || Session::get('cancel')) <button type="submit" class="btn btn-success text-white ms-5">Create</button> @endif
                                    </div>
                                    <div class="col-1">
